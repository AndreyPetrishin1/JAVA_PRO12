...
public enum BotState {
    ...
    Age {
        ...
        public void handleInput(BotContext context) {
            ...
            if(Integer.valueOf(context.getInput()) >=18) {
                context.getUser().setAge(Integer.valueOf(context.getInput()));

                next = EnterPhone;
            }else{
                sendMessage(context, "You are denied registration your age is under 18 ");
                next = Start;
            }
        }
